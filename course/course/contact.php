...
<div class="container mt-5 container-fluid">
  ...
  <div class = "container mt-3">
      <h1>Описание: </h1>
      <p>Благодаря данному сайту вы можете найти спортивные залы в вашем районе, также посмотреть информацию про них.</p>
      <p>И вы можете оставить отзыв через форму обратной связи или написать мне на почту!</p>
  </div>
